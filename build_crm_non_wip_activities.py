...
LIT_LETTERS_PEOPLE_COUNT_EFFECTIVE_DATE2 = _dt.date(2026, 7, 20)
LIT_LETTERS_PEOPLE_COUNT_FROM_EFFECTIVE_DATE2 = 6
def lit_letters_people_count_for_period(period: _dt.date) -> int:
    if period >= LIT_LETTERS_PEOPLE_COUNT_EFFECTIVE_DATE2:
            return LIT_LETTERS_PEOPLE_COUNT_FROM_EFFECTIVE_DATE2
...
DS_PEOPLE_COUNT_THIRD_EFFECTIVE_DATE = _dt.date(2026, 8, 3)
DS_PEOPLE_COUNT_FROM_THIRD_EFFECTIVE_DATE = 36
DS_PEOPLE_COUNT_FOURTH_EFFECTIVE_DATE = _dt.date(2026, 8, 31)
DS_PEOPLE_COUNT_FROM_FOURTH_EFFECTIVE_DATE = 39
DS_PEOPLE_COUNT_FIFTH_EFFECTIVE_DATE = _dt.date(2026, 9, 14)
DS_PEOPLE_COUNT_FROM_FIFTH_EFFECTIVE_DATE = 42
def ds_people_count_for_period(period: _dt.date) -> int:
    if period >= DS_PEOPLE_COUNT_FIFTH_EFFECTIVE_DATE:
        return DS_PEOPLE_COUNT_FROM_FIFTH_EFFECTIVE_DATE
    if period >= DS_PEOPLE_COUNT_FOURTH_EFFECTIVE_DATE:
        return DS_PEOPLE_COUNT_FROM_FOURTH_EFFECTIVE_DATE
...
CPT_PEOPLE_COUNT_THIRD_EFFECTIVE_DATE = _dt.date(2026, 7, 20)
CPT_PEOPLE_COUNT_FROM_THIRD_EFFECTIVE_DATE = 41
CPT_PEOPLE_COUNT_FOURTH_EFFECTIVE_DATE = _dt.date(2026, 7, 27)
CPT_PEOPLE_COUNT_FROM_FOURTH_EFFECTIVE_DATE = 40
CPT_PEOPLE_COUNT_FIFTH_EFFECTIVE_DATE = _dt.date(2026, 8, 3)
CPT_PEOPLE_COUNT_FROM_FIFTH_EFFECTIVE_DATE = 39
CPT_PEOPLE_COUNT_SIXTH_EFFECTIVE_DATE = _dt.date(2026, 9, 14)
CPT_PEOPLE_COUNT_FROM_SIXTH_EFFECTIVE_DATE = 41
def cpt_people_count_for_period(period: _dt.date) -> int:
    if period >= CPT_PEOPLE_COUNT_SIXTH_EFFECTIVE_DATE:
        return CPT_PEOPLE_COUNT_FROM_SIXTH_EFFECTIVE_DATE
    if period >= CPT_PEOPLE_COUNT_FIFTH_EFFECTIVE_DATE:
        return CPT_PEOPLE_COUNT_FROM_FIFTH_EFFECTIVE_DATE
    if period >= CPT_PEOPLE_COUNT_FOURTH_EFFECTIVE_DATE:
        return CPT_PEOPLE_COUNT_FROM_FOURTH_EFFECTIVE_DATE
    if period >= CPT_PEOPLE_COUNT_THIRD_EFFECTIVE_DATE:
        return CPT_PEOPLE_COUNT_FROM_THIRD_EFFECTIVE_DATE
