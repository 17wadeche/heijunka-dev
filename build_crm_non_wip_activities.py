...
CPT_PEOPLE_COUNT_FIFTH_EFFECTIVE_DATE = _dt.date(2026, 8, 10)
...
TEAM_DEFAULT_INPUTS: Dict[str, List[str]] = {
    ...
    "CPT": [CPT_DEFAULT_DIR, CPT_ARCHIVE_PAB_DIR, CPT_ARCHIVE_PAB_DIR2, CPT_ARCHIVE_PAB_DIR3, CPT_ARCHIVE_PAB_DIR4],
