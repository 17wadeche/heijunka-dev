...
commands = [
    ...
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-04-20"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-04-27"], 
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-05-04"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-05-11"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-05-18"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-05-25"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-06-01"],
    ...
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-07-20"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-07-27"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-08-03"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-08-10"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-08-17"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-08-24"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-08-31"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-09-07"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-09-14"],
    [PYTHON_BIN, "push_selected_dates.py", "--date", "2026-09-21"],
