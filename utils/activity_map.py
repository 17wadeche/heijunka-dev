ACTIVITY_MAP = {
    ...
    "meetings, testing, collaboration/event reviews, email/admin":"Meeting",
    "email/im scrum training meeting": "Training/Mentoring",
    "training shadowing": "Training/Mentoring",
    "watching fola do product analysi": "Training/Mentoring",
    "watching myles do chemical change": "Training/Mentoring",
    ...
    "ng meetings coding":"Next Gen",
    "ng, meetings, coding, collaboration/event reviews, email/admin":"Next Gen",
    "training, collaboration, event review":"Collaboration",
    "practice/clinical event":"CQXM Training",
    "coding, smart trees, collaboration, email/admin":"Coding/Code Gov",
    "trainingvent re":"CQXM Training",
    "nextgen - tickets pending":"Next Gen",
    "collaboration, training, event review, supplemental submission":"Collaboration",
    "training, comm/event review, collaboration":"CQXM Training",
    "scrum, training, capa support project":"CAPA",
    "smart trees, coding":"Project Work",
    "scrum, capa support project":"CAPA",
    "capa support project":"CAPA",
    "collaboration, capa support project":"CAPA",
    "collaboration, practice gfe event":"Collaboration",
    "gfe training,practice event":"CQXM Training",
    "gfe task completed":"RI",
    "clinical study) cqxm training":"CQXM Training",
    "training, email/admin.":"CQXM Training",
    "collaboration with gwy":"Collaboration",
    "with madison":"CQXM Training",
    "on nextpulse study) collaboration":"Study",
    "email/collaboration/admin":"Email & IM",
    "meeting with monica":"Meeting",
    "next pulse study) collaboration":"Study",
    "adminstrative":"Admin",
    "letter stuff":"Letter",
    "aira audit prep/collaboration":"Audit",
    "email/messages; training; collaboration":"Email & IM",
    "ri coding collaboration":"RI",
    "self- assigned training":"Cornerstone",
    "administative":"Admin",
    "non - wip categorie":"Non-WIP",
    "admin (email)":"Admin",
    "hep b vaccine":"Admin",
    "shadowing harmony analysi":"CQXM Training",
    "finding work tool":"Metrics & Schedule",
    "scrum,collab":"Scrum & Action",
    "opening fedex ticket and emails about shipment":"Shipment",
    "closurefast issue-pec follow up meeting (non medtronic product)":"Meeting",
    ...
    "internal cqxm meetings, emails/teams, cqxm training":"CQXM Training",
    "internal cqxm meetings, cqxm training, emails/team":"CQXM Training",
    "sr training/cornerstone/internal cqxm meetings/other":"CQXM Training",
    "internal cqxm meetings, emails/teams,":"Meeting",
    "us task practice/training":"CQXM Training",
    "team activity":"Admin",
    "gfe training/event":"CQXM Training",
    "nextgen gch iris smart tree drafting":"Project Work",
    "catch up from leave":"Admin",
    "meetings, coding, smart tree":"Project Work",
    "training, onboarding":"CQXM Training",
    ...
    "emains/team":"Email & IM",
    "training event review, collaboration, new hire admin":"CQXM Training",
    "power hour, collaboration, meeting":"Power Hour",
    "power hour, collab":"Power Hour",
    "cornerstone/mdt aca":"Cornerstone",
    "scrum, internal cqxm meeting, training":"Scrum & Action",
    "power hr":"Power Hour",
    ...
    "to missing product to eu/us srs - cmp":"Admin",
    "collaboration, admin":"Collaboration",
    "team/email":"Email & IM",
    "training support/cornerstone/emails/cqxm internal meetings/other":"CQXM Training",
    "rd training/sr review/emails/team/cqxm internal meetings/cornerstone/other":"CQXM Training",
    "reviewed teams meetings from ooo/reviwed fax response from gavin in neuro/late mdr call/emails/teams/scheduling":"Email & IM",
    "emails/teams requests/completing non-eu vig rrs for submission/complting rds/scheduling":"Email & IM",
    "cqxm mentioring":"CQXM Mentoring",
    "internal cqxm meeting: 15.":"Meeting",
    "concerto and vs":"Project Work",
    "medtronic ai survey":"Admin",
    ...
    "cqxm training: 100 (includes literature training)":"CQXM Training",
    "email/messages; mentoring":"CQXM Mentoring",
    "cornerstone/self trainiong":"Cornerstone",
    "emails/teams/":"Email & IM",
    "training/reviewing/emails/cqxm internal meetings/other":"CQXM Training",
    "training/shadowing/review":"CQXM Training",
    ...
    "training, notes, emails, cornerstone":"CQXM Training",
    "next gengch iris tree drafting":"Next Gen",
    "lab meeting & task":"Meeting",
    "admin/|email":"Admin",
    ...
    "nextgen gch uat example":"Next Gen",
    "files smdr":"Admin",
    ...
    "other bo report update":"Data Request/Review",
    "training, onboarding, collaboration, video recording, team meeting":"CQXM Training",
    "training, onboarding, collaboration, video recording, power hour":"CQXM Training",
    "other - illuminate":"Other",
    ...
    "training/sign off sacra":"CQXM Training",
    "administrative, cqxm training, internal cqxm training":"Admin",
    "sacra_rd -review 10 files and signed off":"CQXM Training",
    "investigation training with vuyo":"CQXM Training",
    "internal cqxm training, other mdt team meeting, administrative, cqxm training":"CQXM Training",
    "reassign on sr tab":"WIP Event/Review",
    "nextgen gch":"Next Gen",
    "other correction in past file":"WIP Event/Review",
    "other self training instrument":"Cornerstone",
    ...
    "admin/emails/teams/cqxm training/other":"Admin",
    "scrum, email/admin, collab":"Scrum & Action",
    "product issue meeting with marie":"Meeting",
    "batchman training":"Batchman",
    "cit audit prework":"Audit",
    "training prep and training":"CQXM Training",
    "special/escalated request":"Admin",
    "team meeting, scrum, email/admin":"Meeting",
    "collab,scrum":"Collaboration",
    "cqxm - letter":"CQXM Training",
    "cqxm -denise":"CQXM Training",
    "metrics and scheduling":"Metrics & Schedule",
    "cornerstone training module":"Cornerstone",
    "cornerstone,collab":"Cornerstone",
    "collaboration, cornerstone":"Collaboration",
    "audit - cit product list request":"Audit",
    "cornerstone training due":"Cornerstone",
    "check-in with marie":"Collaboration",
    "pull reports for audit":"Audit",
    "running batchman for the first time":"Batchman",
    "audit - gmed":"Audit",
    "other - inclusion":"Engagement",
    "cas team meeting":"Meeting",
    "internal cqxm meetings, collaboration, email/admin":"Meeting",
    "cqxm-letter":"CQXM Training",
    ...
    "cqxm traiing -denise":"CQXM Training",
    "collab, emails/admin,scrum":"Collaboration",
    "cqxm-literature":"CQXM Training",
    "email/admin, collaboration":"Collaboration",
    "questions with marie":"Question",
    "cqxm training - denise":"CQXM Training",
    "collab, emails/admin":"Collaboration",
    "uat proxbox":"Project Work",
    "aging tasks (30)":"Aging Task",
    "admin/email/team":"Admin",
    "collab/emails/admin":"Collaboration",
    "collaboration email/admin.":"Collaboration",
    "scrum, collaboration, internet issue":"Scrum & Action",
    "scrum, computer issue":"Scrum & Action",
    "proxbox uat":"Project Work",
    "other - studie":"Other",
    "scrum (10)":"Scrum & Action",
    "investigation/sacra training cqxm training":"CQXM Training",
    "cqxm training investigation with conor":"CQXM Training",
    "cqxm training; shadowing w rodrigo on italy vig":"CQXM Training",
    "fwt reassign sr tab, scrum, cqxm training":"CQXM Training",
    "internal cqxm meeting, cornerstone":"Cornerstone",
    "scrum, administrative":"Scrum & Action",
    "admin/ email":"Admin",
    "cqxm mentoring/cornerstone/cqxm internal meetings/other":"CQXM Mentoring",
    "cqxm training/cornerstone/emails/teams/other":"CQXM Training",
    "cornerstone/self learning":"Cornerstone",
    "cornerstone/ self training":"Cornerstone",
    "personal inbox, cornerstone, emails/teams, audit prep meting":"Email & IM",
    "requests, emails/teams, complaint list request, audit meeting":"Audit",
    "emails/teams, cqxm meetings/gemba, precedent event review, audit meeting":"Meeting",
    "emails/teams, pmpa review of gooey letters, schedule":"PMPA",
    "emails/teams, internal cqxm meetings, nextgen, cqxm training":"Next Gen",
    "emails/team/cqxm training/other/cqxm internal meeting":"CQXM Training",
    "emails/teams, cornerstone / self training, internal cqxm meeting":"Cornerstone",
    "cqxm training/emails/teams/cqxm internal meetings/other":"Email & IM",
    "emails/cornerstone/cqxm internal meeting/other":"Meeting",
    ...
    "training, onboarding, collab, event review":"CQXM Training",
    "collaboration/admin":"Collaboration",
    "mmo audit prework":"Audit",
    "training shadowing new hire":"CQXM Training",
    "collab calls answering question":"Collaboration",
    "audit - mmo":"Audit",
    "1`":"",
    "scrum, shadowing, collab, admin":"Scrum & Action",
    "fcc breach mtg":"Meeting",
    "internal cqxm meeting, email/admin":"Meeting",
    "uat test script":"Project Work",
    "interal cqxm meeting":"Meeting",
    "training/cornerstone, admin.":"Cornerstone",
    "other required task":"Admin",
    "impromptu call":"Meeting",
    "teams call w monica pardini":"Meeting",
    "sollaboration":"Collaboration",
    ...
    "training,onboarding,collaboration":"CQXM Training",
    "training, onboarding, collaboration":"CQXM Training",
    "scrum, email/admin":"Scrum & Action",
    "scrum, email, collaboration":"Email & IM",
    "collab (25)":"Collaboration",
    "rdn generator training":"CQXM Training",
    "investigation training on rfg":"CQXM Training",
    "weekly report for uni":"Admin",
    "analysis training on rfg":"CQXM Training",
    "helping scott wih image":"Collaboration",
    "dt equipment set up images with jt for customs and dt team rice creek":"Admin",
    "ict tier 2 (including prep)":"Meeting",
    "sh manufacturign & r&d":"Admin",
    "sorting arrival of closurefast ftir with us department":"Sorting",
    "internal cqxm team":"Meeting",
    "collaboratio":"Collaboration",
    "sr reassignment, emails, meeting":"Email & IM",
    "email/messages; scrum":"Email & IM",
    ...
    "scheduel":"Metrics & Schedule",
    "collab (15)":"Collaboration",
    "meetings/collab":"Meeting",
    "internal cqxm meetin":"Meeting",
    "sh letter":"Letter",
    "internal cqqxm meeting":"Meeting",
    ...
    "unassigned srs":"WIP/Event Review",
    "capa pr":"CAPA",
    "sr reassignment, scrum, meeting":"WIP/Event Review",
    ...
    "email/admin. training prep":"Email & IM",
    "internal cqxm meeting (15)":"Meeting",
    ...
    "reg inquiry":"RI",
    "training support/cqxm internal meetings/cornerstone/other/email":"CQXM Training",
    ...
    "collaboration, smart trees-hard to focus (migraine), cornerstone, email/admin":"Collaboration",
    "ng, smart trees, event reviews, email/admin":"Project Work",
    "nexgen":"Next Gen",
    "ng, smart trees, collaboration":"Next Gen",
    "gfe call":"Meeting",
    "us task training":"CQXM Training",
    "us task training / merge":"CQXM Training",
    "mir review":"WIP/Event Review",
    "power hour, one on one":"Power Hour",
    "team":"Email & IM",
    "reassess task":"WIP/Event Review",
    "email/admin.":"Email & IM",
    "team collabortion":"Collaboration",
    "email & team":"Email & IM",
    "sr practice event":"CQXM Training",
    "training gfe/tasks collaboration":"CQXM Training",
    "team building activity":"Engagement",
    "practice clinical event":"CQXM Training",
    "project/letter pull for director":"Project Work",
    "gfe event":"RI",
    "it issues/windows update":"IT Issue/Update",
    "emails/ teams admin work":"Email & IM",
    "training support/cqxm internal meetings/other":"CQXM Training",
    "cqxm training: , internal meeting:":"CQXM Training",
    "internal cqxm meetings, emails/team":"Meeting",
    "training support/other/inbox/cqxm internal meeting":"CQXM Training",
    "aira audit prep":"Audit",
    "mdr/vig mtg/prep":"Meeting",
    "misc gen rfr use":"Next Gen",
    "q1fy":"Admin",
    "gfe practice event":"CQXM Training",
    "powerhr":"Power Hour",
    "reassess trainig/practice event":"CQXM Training",
    "reassess review":"CQXM Training",
    "reassess training":"CQXM Training",
    "teams call":"Email & IM",
    "collab (10)":"Collaboration",
    "emails/teams, administrative, internal cqxm meeting":"Meeting", 
    "mdt academy/self-training":"Cornerstone",
    "emails/teams, internal cqxm meetings, cornerstone / self training":"Meeting",
    "training/cqxm internal meetings/other":"CQXM Training",
    ...
    "email/messages; collaboration":"Email & IM",
    "power (60)":"Power Hour",
    ...
    "emails/ admin":"Admin",
    "power hour (60)":"Power Hour",
    "teans call":"Meeting",
    "merges after product analysis task was closed":"WIP/Event Review",
    "finished":"WIP/Event Review",
    "fmla":"OOO",
    ...
    "training/cqxm internal meetings/emails/team":"CQXM Training",
    ...
    "emails/tm":"Emails & IM",
    "/ tier":"Meeting",
    "personal development/goals/erg":"Career Development",
    "gemba prep and meeting":"Meeting",
    "lab meeting tier":"Meeting",
    "project / ou launch support":"Project Work",
    "pec meeting/ou complaint meeting":"Meeting",
    "pa live rpa meeting with ou, r&d":"Meeting",
    ...
    "vitalflow training":"CQXM Training",
    "administrative_sr reassign":"Admin",
    "investigation & check- in meeting":"Meeting",
    "initial vig training":"CQXM Training",
    "it issues/ admin work":"IT Issue/Update",
    "occ health call":"Meeting",
    "other - business object request":"Data Request/Review",
    "training 2a":"CQXM Training",
    "internal cqxm metting 20":"Meeting",
    "internal cqxm meeting 20":"Meeting",
    "admnistrative":"Admin",
    ...
    "project research":"Project Work",
    "ooo - certified leave":"OOO",
    "ooo - annual leave":"OOO",
    "ooo - other leave":"OOO",
    "diamond temp presentation":"Project Work",
    "collecting and setting up laptop":"IT Issue/Update",
    "reviewing versa complaint":"WIP/Event Review",
    "project presentation":"Project Work",
    "santa rosa voyager deco":"Voyager",
    "year-end review (30)":"Career Development",
    "pe files fix":"WIP/Event Review",
    "cqe":"Admin",
    "cqe training meeting": "Training/Mentoring",
    "tm support/querie":"Collaboration",
    "next gen testing":"Next Gen",
    "review training event": "Training/Mentoring",
    "trainings / rr": "Training/Mentoring",
    "event selection for marisa ashik and niloufer": "Training/Mentoring",
    ...
    "goals and strategies meeting":"Career Development",
    "emails iri":"Email & IM",
    "fy":"Career Development",
    "call on file with tm":"Collaboration",
    "fu std q's word doc":"Admin",
    "fu std word doc":"Admin",
    "dcb device reading":"Reviewing Documents & Case Video",
    "presentation dt folder uploads to sharepoint":"Admin",
    "emails and admin":"Email & IM",
    ...
    "clinical/ rr training": "Training/Mentoring",
    "scrum, collaboration, email/event, cornerstone":"Scrum & Action",
    "scrum, pulling aes":"Scrum & Action",
    ...
    "italy portal download":"Admin",
    "sap request":"IT Issue/Update",
    "ri review/comment":"RI",
    "email/im stent graft id job aid update":"Email & IM",
    "pmq cr pre-meeting qs review 30email & im":"Meeting",
    "liberant issues-updated":"Project Work",
    ...
    "clinical study reviewed - safety and performance assessment of the affera sphere-9tm ablation catheter and system for the mapping and ablation of vt":"Study",
    ...
    "shipping device to nellcor (printer issues)":"Shipment",
    "meeting with paddy burke-rf tester issue":"Meeting",
    "calibration form completion for oscilloscope (remove from service)":"Calibration",
    "equipment set up for meeting":"Set Up",
    "aortic cross functional review":"Meeting",
    "grad intenr meeting":"Meeting",
    "performance review with aurelie":"Career Development",
    ...
    "ad hoc emails/questions from team/emails from cqxm inbox emails, scrum, late rr":"Admin",
    "breakie":"Break",
    ...
    "scrum, comm training,":"Scrum & Action",
    "comm task completed":"WIP/Event Review",
    "read proceedure training":"Admin",
    ...
    "review/practice art event,collab, cornerstone, emails/admin":"Collaboration",
    "art practice event, admin,collab,email":"Admin",
    "collaboration, emails/admin":"Collaboration",
    "collaboration, email/admin":"Collaboration",
    "/ollab":"Collaboration",
    ...
    "nextgen, emails/team":"Next Gen",
    "meetings(other)": "Meeting",
    "crdn pmq call": "Meeting",
    "compulsory restart":"IT Issue/Update",
    ...
    "collaboration/analysis discrepancies, emails/admin., windows update":"Collaboration",
    "collaboration/emails/admin":"Collaboration",
    "additional training videos for dt (marmars request)":"Training/Mentoring",
    "helping scott with videos on diamond catheter":"Admin",
    ...
    "review of case report forms for new clinical study - conquer af approved horizon":"Study",
    "mfth prep":"Meeting",
    "collaboration/email":"Collaboration",
    ...
    "scrums / aem / emails / teams messages / reg inquirie":"RI",
    "aems and townhall":"Meeting",
    "townhall/aem":"Meeting",
    "aem and townhall":"Meeting",
    "emaiils admin":"Admin",
    "added pli":"WIP/Event Review",
    "global town hall meeting":"Meeting",
    "pvh report/gch master data":"Team Report",
    "investigation template":"Project Work",
    ...
    "crdn video":"Reviewing Documents & Case Video",
    "watching deco chemical change":"Admin",
    "addtional picture":"Admin",
    "x-ray device in b":"Admin",
    "observing aortic deco":"Admin",
    "addtional picture":"Admin",
    "collecting battery tester from workshop":"Admin",
    "iris tree review":"Project Work",
    "reading through past heli-fx analyse":"Reviewing Documents & Case Video",
    "familiarizing with force meter":"Admin",
    "transcarotid presentation recording":"Admin",
    "argon shipment issue":"Shipment",
    "bag device":"Bagging",
    "email query":"Email & IM",
    "inert tags meeting":"Meeting",
    "setting up the lab":"Set Up",
    "data check":"Data Request/Review",
    "qa assessment query":"QA",
    "boxi report":"Data Request/Review",
    "food truck 11:30":"Engagement",
    "06/22: scrum/it chat/cornerstone/inbox event":"Admin",
    "it (gch issues)/faxes/scrum":"IT Issue/Update",
    ...
    "email catch up etc":"Email & IM",
    "training suppor": "Training/Mentoring",
    "investigation mtg":"Meeting",
    "pop.fywt":"Metrics & Schedule",
    ...
    "map agile it issue resolution": "IT Issue/Update",
    "questions call on pending file":"Question",
    "slef paced investigation module": "Training/Mentoring",
    ...
    "email, admin":"Email & IM",
    "email. admin":"Email & IM",
    "answering queries on file":"Question",
    "placement details with uni":"Admin",
    "training reading proceedure": "Training/Mentoring",
    "researching chemicals for project":"Project Work",
    "remove from service dt form completion":"Admin",
    ...
    "’s":"",
    "req inquirie":"RI",
    "audit req, inv req for testing, code updates with devin, inv meeting, schedule, scrum":"Audit",
    "france meeting, pe review with team member, schduling, adhoc emails about france dossier/supporting surprise audit":"Meeting",
    "adhoc events for updates/merges/etc./call w/ kaitlin":"Meeting",
    "adhoc events for updates/merges/etc./finished rd merges and correction":"WIP/Event Review",
    "1:1/scrum/emails/fax reviews/reviwing event":"Meeting",
    "worked some srs, scrum, lunch, email":"Admin",
    "scrum, chat with it on mir classification (avalus ultra), lunch,email":"Admin",
    "creating faxes/reviewing events/scrum/eu training material": "Training/Mentoring",
    "envair visit":"Admin",
    "goals in workday":"Career Development",
    "reading through steerant doc":"Reviewing Documents & Case Video",
    "gch bu units access for jt":"IT Issue/Update",
    "reading through closurefast stylette doc":"Reviewing Documents & Case Video",
    "co op monthly meeting":"Meeting",
    "closing out general pm's on sap":"IT Issue/Update",
    "laptop restart & problem":"IT Issue/Update",
    "tier 2 ict":"Meeting",
    "reviewing files for audit":"Audit",
    "remove from service calibration form creation":"Calibration",
    "ict":"Meeting",
    "pvh":"Meeting",
    "chemical order for shutdown":"Ordering",
    "sending device to analtyical lab":"Shipment",
    "ict & aaortic tier":"Meeting",
    "email/admin/teams message":"Email & IM",
    "meeting/call":"Meeting",
    "follow up querie":"Question",
    "answering questions on file":"Question",
    "training on invs for hms/act": "Training/Mentoring",
    "goal":"Career Development",
    "questions on pending file":"Question",
    "pending files question":"Question",
    "emails escalated call and prep":"Meeting",
    "clinical prevail request":"Admin",
    "tm meetings x":"Meeting",
    "ng coding meetings team meeting":"Next Gen",
    "collaboration, email/admin.":"Collaboration",
    "collab with ruth to help her set up italy portal":"Collaboration",
    "post analysis rr training collab": "Training/Mentoring",
    "post analysis rr training": "Training/Mentoring",
    "mir collaboration":"Collaboration",
    "audit (45)":"Audit",
    "entering goals emails/admin":"Career Development",
    "pest email, collaboration":"Collaboration",
    "fwt, email": "Metrics & Schedule",
    "it issues update/restart":"IT Issue/Update",
    "tourguide job aid update":"Admin",
    "biobox job aid update":"Admin",
    ...
    "reading sentrant tmv": "Reading File/Document Information",
    ...
    "qa report out":"QA",
    "misc/admin":"Admin",
    "ng, coding, meetings, event review, email/admin":"Next Gen",
    "ng, meetings, coding, event review, email/admin":"Next Gen",
    "clinical studie":"Study",
    "audit question":"Audit",
    "email catch up after leave and admin":"Admin",
    "ftir/analytical lab document review":"Admin",
    "morning admin and catchup after leave":"Admin",
    "fixture work":"Admin",
    "lab replishment meeting": "Meeting",
    "closurefast with scott": "Training/Mentoring",
    "chemical stock and expiry check":"Admin",
    "ehs observation and facilities tickets opened":"Admin",
    ...
    "emails (30) sorting ftir testing":"Email & IM",
    "lab visit":"Admin",
    "morninng admin":"Admin",
    "prepping shipment to state":"Shipment",
    "states meeting":"Meeting",
    ...
    "pmpa training reverse": "Training/Mentoring",
    "break/ email":"Email & IM",
    "capa risk assessment":"CAPA",
    "complaint list for parker": "Training/Mentoring",
    ...
    "clinical review uat update":"Project Work",
    "scrum xx pulling relevant pe files/review":"Scrum & Action",
    "bo report cpt - update and schedule":"Data Request/Review",
    "answering querie":"Collaboration",
    "tl activities meetinfg":"Meeting",
    "cornerstone retirement celebration":"Engagement",
    "rdn meeting":"Meeting",
    ...
    "cathworks paa":"Cathwork",
    "project genie dd":"Project Work",
    "4 in fwt - act/hms investigation": "Metrics & Schedule",
    "risk assessment questionnaire (60)":"Admin",
    "risk assessment questionaire":"Admin",
    "sh picardia dd support":"Project Work",
    "project genie":"Project Work",
    ...
    "lab call":"Meeting",
    "s":"",
    "adhoc emails, scrum, weekly cqxm/pmpa review, oc weekly complaint review, scheduling, audit support":"Audit",
    "capa questionnaire training /cornerstone/scrum":"CAPA",
    "reviewing events/scrum/questionnnaire related training in cornerstone":"Cornerstone",
    "scrum, eu training, pp review":"Training/Mentoring",
    "risk assessment quiz":"Admin",
    "qr":"Admin",
    "questionaire assesment":"Admin",
    ...
    "fu stq q's review/edit doc":"Admin",
    "mdt academy self directed training": "Training/Mentoring",
    "sh letters check":"QA",
    "uat approval":"Project Work",
    ...
    "new joiner training": "CQXM Training",
    ...
    "cornerstone / classroom training":"Cornerstone",
    "pmpa/r&d meeting":"PMPA",
    ...
    "sent rr/reviewed completed faxes for team member training":"Training/Mentoring",
    "audit support - dhr review":"Audit",
    "pmpa questoins/update":"PMPA",
    "hg, meetings, medical safety review, event reviews, collaboration, email/admin":"Collaboration",
    "training, collaboration event review, meeting":"Training/Mentoring",
    "scrum, aem, weather drill, training":"Training/Mentoring",
    "employee meeting":"Meeting",
    "rr training":"Training/Mentoring",
    "training prep and reviewing event":"Training/Mentoring",
    "training/prep":"Training/Mentoring",
    "scrum,trainig.":"Training/Mentoring",
    ...
    "scrum, team meeting, training":"Scrum & Action",
    "collbaoration":"Collaboration",
    "organization":"Admin",
    ...
    "mentoring / answering question":"CQXM Mentoring",
    ...
    "ng, coding, meetings, event reviews/collaboration, email/admin":"Next Gen",
    "collaboration/ sup rr training":"Training/Mentoring",
    "comm sent for hypercare":"Project Work",
    "team collaboration, training prep":"Training/Mentoring",
    "collaboration (15)":"Collaboration",
    ...
    "report out feedback meeting":"Meeting",
    "compulsory computer restart":"IT Issue/Update",
    "system update":"IT Issue/Update",
    ...
    "getting access and approval for jt":"IT Issue/Update",
    "training sheet for eoin c and toma":"Training/Mentoring",
    "reviewing file to help plymouth with mfg assessment":"WIP/Event Review",
    "retrieving devices from archive":"Archive",
    "training sheet":"Training/Mentoring",
    ...
    "and scrum":"Scrum & Action",
    "reviewing slides on sharepoint":"Admin",
    ...
    "july sustainability tracker":"Admin",
    ...
    "fu std q'& soe call":"Meeting",
    "italy vig report call":"Meeting",
    "doubt":"Question",
    ...
    "scrum,gfe training":"Training/Mentoring",
    "meeting, emails/admin., collaboration":"Meeting",
    "scrum, collaboration, emails, cornerstone":"Scrum & Action",
    "collaboration (30)":"Collaboration",
    "p":"",
    "enterprise/medical safety discussion/review":"Meeting",
    "action items from late report meeting":"Meeting",
    "late mtg":"Meeting",
    "late rr meeting":"Meeting",
    "emails admin clinical metrics/schedule/wip mgmt training":"Training/Mentoring",
    "ml ai rd gap report":"Data Request/Review",
    "meeting scrum":"Scrum & Action",
    "review events/creating faxes/emails/discussion with team/scrum":"Admin",
    "adhoc emails/team questions, problem solving, working session meeting with alison, schedule":"Admin",
    "breakfast for myle":"Engagement",
    "myles breakfast":"Engagement",
    "reading past file":"Reviewing Documents & Case Video",
    "researching chemicals for grad project":"Project Work",
    "mcl meeting":"Meeting",
    "farewell breakfast for myle":"Engagement",
    "uni goal strategy":"Career Development",
    "writing weekly report":"Team Report",
    "aortic rgi":"RI",
    "administrative:30 next gen: emails/teams: projects: clinical:":"Admin",
    "meeting china ri":"RI",
    "looking at past analyse":"WIP/Event Review",
    "crdn weekly complaints review":"WIP/Event Review",
    "sorting a file":"Sorting",
    "attempted flushing/ clearing of liberant aspiration tubing (a lot of dried biologics)":"Admin",
    "goal strategy":"Career Development",
    "r&d tax credit, email, admin":"Admin",
    "biohazard kit inbox/approvals scrum pmq cr pre-meeting q's review":"Biohazard Kit",
    "scrum 30.":"Scrum & Action",
    "tm support and submit rr for penditure event":"Collaboration",
    "brooklyn park mtg":"Meeting",
    "internal cqxm meeting":"Meeting",
    "breakfast, finishing up last few bit of paper work for college":"Admin",
    ...
    "ellipsys dhr":"WIP/Event Review",
    "chemical stock take walk through with jt":"Admin",
    "fixing deco drainage (blockage)":"Admin",
    "r&d reviewing aortic device":"Admin",
    "sr shadowing with pat":"Training/Mentoring",
    "bfarm ri":"RI",
    "fx+ tissue meeting":"Meeting",
    "external meeting":"Meeting",
    "fyet":"Metrics & Schedule",
    "post analysis events and training":"Training/Mentoring",
    "scrum, medtronic academy":"Scrum & Action",
    ...
    "im's to lab on exception file": "Email & IM",
    ...
    "cornerstone/self training":"Cornerstone",
    "tm":"Collaboration",
    "scrum/ discussion":"Scrum & Action",
    "gfe training, scrum":"Training/Mentoring",
    "trending mtg":"Meeting",
    "fu std q":"Admin",
    ...
    "dt meeting": "Meeting",
    "audit complant list":"Audit",
    "potential precedent event review":"Precedent Event",
    "late rr discussion/prep":"Meeting",
    "strategy&goal":"Career Development",
    "follow up q meeting":"Meeting",
    "gq meeting":"Meeting",
    "endurant twist report/review":"Project Work",
    "biohazard kit issue":"Biohazard Kit",
    "biohazard kits approval":"Biohazard Kit",
    "training collaboration burndown":"Training/Mentoring",
    "event reviews, rrtts, meetings, email/admin":"WIP/Event Review",
    "collaboration, meetings, email/admin":"Collaboration",
    "intuition mtg":"Meeting",
    "capa & remediation work":"CAPA",
    "merge work and email": "Email & IM",
    "preparing data for pmq/cqxm alison meeting,meeting with clnical teams about pmcf survey, met with jenifer for pmq/cqxm meeting, created pmcf events, schedule":"Admin",
    "preping data for france team/alison data prep for pxm/cqxm transfer meeting/updated other events/late mdr call/questions from team":"Admin",
    "power turned off at home":"IT Issue/Update",
    "scrum, lunch, emails, communication with it":"IT Issue/Update",
    "reviwing events/ 4 rrs/creating faxes/ one cornerstone training":"Training/Mentoring",
    "training proceedure reading":"Training/Mentoring",
    "jt sign off sheets from device tracker":"Admin",
    "making ftir memo":"Admin",
    "looking through crdn past file":"WIP/Event Review",
    "helping review a flex cath device":"Admin",
    "reviewing iris tree question document":"Project Work",
    "iris tree meeting":"Project Work",
    "training proceedure read":"Training/Mentoring",
    "email, admin, cornerstone":"Admin",
    "r&d tax credit review":"Admin",
    "call about escalation tracker excel":"Meeting",
    "annex c discussion":"Coding/Code Gov",
    "reviewing documents and signing":"Admin",
    "it problem":"IT Issue/Update",
    "rdn generator transfer meeting":"Meeting",
    "neuro device shipment meeting with myle":"Meeting",
    "versa dhr":"WIP/Event Review",
    "computer compulsory restart":"IT Issue/Update",
    "labels/custompoint":"Admin",
    "scrum xx pulling pe file":"Scrum & Action",
    "cornerstone/workday":"Cornerstone",
    "email, admin etc.":"Email & IM",
    "lab meeting and file processing":"Meeting",
    "parker investigation":"WIP/Event Review",
    "mfg & exp date update":"WIP/Event Review",
    "mfg/exp dates updating file":"WIP/Event Review",
    "set up: 10 (had some issues signing in this morning)":"IT Issue/Update",
    "sr sw document update":"Admin",
    "filling out heijunka and timesheet":"Metrics & Schedule",
    "cornerstone, emails/admin, collaboration":"Cornerstone",
    "email/admin, collab, burndown":"Admin",
    "meeting with jyn (60 mins)":"Meeting",
    "practice post analysis event":"Training/Mentoring",
    "pulseselect overview training with denise":"Training/Mentoring",
    "email/admin, collab":"Admin",
    "prox box":"Admin",
    "imf coding meeting":"Coding/Code Gov",
    "ri review/submission":"RI",
    "imf coding":"Coding/Code Gov",
    "clinical contact process":"Admin",
    "pmq rfr call":"PMQ Meeting",
    "handover meeting":"Meeting",
    "mhra ri report":"RI",
    "code":"Coding/Code Gov",
    "pvh qch query":"Question",
    "ra recert query":"Question",
    "list/scenarios f":"Admin",
    "shadowing eoin on crdn":"Training/Mentoring",
    "grad project researching chemical":"Project Work",
    "letters training":"Training/Mentoring",
    "handover meting":"Meeting",
    "ri check":"RI",
    "sorting liberant return":"Sorting",
    ...
    "scrum, event reviews, ms":"Scrum & Action",
    "scrum, rework of events from day before":"Scrum & Action",
    "teams msg": "Email & IM",
    "collaboration/emails, scrum":"Collaboration",
    "prep for training":"Training/Mentoring",
    "of ashik's practice us reg report":"Training/Mentoring",
    "bake sale":"Engagement",
    "wip pulls/ assignment/ anomaly check": "Metrics & Schedule",
    "gfe training":"Training/Mentoring",
    "ri training; job aid update":"RI",
    "pvh aged file review":"WIP/Event Review",
    "pmpa coding discussion":"PMPA",
    "mtg w/ enterprise re coding":"Meeting",
    "update outputs/availability for next week/meeting planning":"Admin",
    "pending rds":"WIP/Event Review",
    "gemba and gemba prep":"Gemba",
    "audit review complaint file":"Audit",
    ...
    "post analyis practice events x3":"Training/Mentoring",
    "atlas sw hypercare":"Project Work",
    "audit prep/complaint report":"Audit",
    "team collaboration (30)":"Collaboration",
    ...
    "sap review & product return - lab esc.":"Escalation",
    "escalation tracker":"Escalation",
    "ou weekly escalation":"Escalation",
    "escalation":"Escalation",
    "aged gfe escalation to commercial org":"Escalation",
    ...
    "escalations on external dependencies":"Escalation",
    "file escalations/sr":"Escalation",
    "pvh tier": "Meeting",
    ...
    "file escalations/signal review corrections (gap findings, fer escalations)":"Escalation",
    ...
    "iq update for cirris tester":"Admin",
    "extra testing in lab on protege device":"Admin",
    "vs file":"Admin",
    "incorporating feedback":"Admin",
    "retrieving products from oasis delivery":"Admin",
    "calibration sheet update":"Calibration",
    "transferring valve return kit":"Admin",
    "majella investigation":"WIP/Event Review",
    ...
    "retaking lab analysis image":"Analysis",
    "reading analysis feedback":"Analysis",
    "observing reliant analysi":"Analysis",
    "retaking analysis image":"Analysis",
    ...
    "retrieving device from oasis issue":"Admin",
    "uat issue follow up (shiperp)":"Project Work",
    "crdnt":"Meeting",
    ...
    "scrum,training":"Scrum & Action",
    "interviews & pre and post action":"Admin",
    "pvh open wip drill":"WIP/Event Review",
    "pvh ou report": "Team Report",
    "clinial cip review/input":"Admin",
    "report query": "Team Report",
    "scrum,collaboration":"Scrum & Action",
    "cross -functional meeting" :"Meeting",
    "metrics/scrum":"Scrum & Action",
    "check in meeting" :"Meeting",
    "crum":"Scrum & Action",
    "/ pmpa meeting":"PMPA",
    "ems/querie":"Question",
    "pvh rr upload":"WIP/Event Review",
    ...
    "preliminary uat testing":"Project Work",
    ...
    "reading through aortic device manual":"Reading File/Document Information",
    "dt temp (sorting through returned catheters and re-packing boxes for oasis)":"Admin",
    "calibrations coe":"Calibration",
    "uat":"Project Work",
    "uat sign-off":"Project Work",
    "medical centre appointment":"Appointment",
    "inpact 018 xl meeting":"Meeting",
    "issues with shiperp":"Shipment",
    "sorting crdn request":"Admin",
    "on line training inpact 018 xl":"Training/Mentoring",
    "finished and uploaded valve stock 20":"Admin",
    "requesting archive boxes from oasi":"Archive",
    "acrum":"Scrum & Action",
    "scrum.":"Scrum & Action",
    ...
    "organising crdn devices on hold":"Admin",
    "occ. health":"Occ Health",
    "cancelling dhr tasks, opening cm/oem tasks and completing form, pulling vena seal adhesive lot number from sap":"Admin",
    ...
    "making a list of in house valve":"Admin",
    "harmony r&d review":"Admin",
    "breaking sh/a device":"Admin",
    "reading past aortic write ups":"Reading File/Document Information",
    "deco device clarification":"Collaboration",
    "crdn":"Meeting",
    "rd guidance/inbox/stratgey/audit prep/scheduling":"Audit",
    "scrum/cornerstone/reviweing events/ fy27 startegy meeting":"Admin",
    "adhoc/following up for events/late mdr call/scheduling":"RFAI",
    "scrum, inv training, lunch, workday":"Admin",
    "eu/vig training/scrum/training practise":"Training/Mentoring",
    "eu training/scrum/reading training material":"Training/Mentoring",
    "ad hoc email":"Email & IM",
    "cornerstone/prm training/scrum":"Training/Mentoring",
    "sending rrs/comm":"Admin",
    "adhoc emails to reps/confiming ai":"Email & IM",
    "eoy convo":"Career Development",
    "reviewing events with team member":"Training/Mentoring",
    "cornerstone video":"Cornerstone",
    "additional gfe":"RFAI",
    "aortic knowledge share recording":"Meeting",
    ...
    "lab showcase with visitor":"Admin",
    ...
    "rr audit events,collab":"Audit",
    "training event review":"Training/Mentoring",
    ...
    "email & im mdt academy self directed training call":"Email & IM",
    ...
    "rr doubt":"Question",
    "collaboration, system crash":"IT Issue/Update",
    "conquer af csmpcp study":"Study",
    "set-up: emails: escalation tracker updates and call":"Set Up",
    "tm support meeting":"Collaboration",
    "better workday workshop":"Career Development",
    "emails fw, lab tidying, lab tour,":"Admin",
    "shadowing fola in lab":"Training/Mentoring",
    "pmpa/r&d review meeting":"PMPA",
    "email/im cs communications report":"Email & IM",
    "clinical uat meeting":"Project Work",
    "goals review":"Career Development",
    ...
    "hyperecare meetings/action item":"Project Work",
    "scrum, letter review":"Scrum & Action",
    "crash":"IT Issue/Update",
    "scrum, eu training":"Training/Mentoring",
    ...
    "scrum, reviewing reassess rd":"Scrum & Action",
    "pulling relevent pe file": "WIP/Event Review",
    "meetings - scrum":"Meeting",
    "letter training before microsoft crash":"IT Issue/Update",
    "rr audit/ collaboration":"Audit",
    "cs":"Cornerstone",
    "new hire training":"Training/Mentoring",
    "hospital appoint.":"Admin",
    "email & im goals meeting":"Career Development",
    "it call for rs issue":"IT Issue/Update",
    "bo unused report review":"Data Request/Review",
    "pa task review": "WIP/Event Review",
    "reg query":"Question",
    "grc request for jt and access":"IT Issue/Update",
    "working with analytical chemistry group for shipment timeline":"Shipment",
    "hospital appoint":"Admin",
    "gch access for jt":"IT Issue/Update",
    "dcb manufacturing asessment":"Admin",
    "jt to b":"IT Issue/Update",
    ...
    "crdn&pvh":"Meeting",
    "start on spider investigation cheat sheet":"Training/Mentoring",
    "bi launchpad request":"Data Request/Review",
    "collaboration/ rr overview ( 120)":"Collaboration",
    "collaboration/ training (120)":"Training/Mentoring",
    "training, internet issue":"Training/Mentoring",
    "cw/gch/system issue":"IT Issue/Update",
    "updating schedule/available wip":"Metrics & Schedule",
    "responding to email":"Email & IM",
    "clincial trial approval in docusign":"Admin",
    "bi lauch pad":"Data Request/Review",
    "deco clean up":"Admin",
    "hele-fx file":"WIP/Event Review",
    "bi launchpad access and sap access":"Data Request/Review",
    "no cal memo and sticker":"Admin",
    ...
    "doubt session call": "Meeting",
    "invoice update dt equipment":"Invoice",
    "picking up laptop from it and updating":"IT Issue/Update",
    "restart laptop x2":"IT Issue/Update",
    "oem/cm form":"Admin",
    ...
    "scrapping device":"Scrapping",
    "files reassessment review":"Admin",
    "list of device":"Admin",
    "ict & aortic tier 2": "Meeting",
    "jt access request":"IT Issue/Update",
    "r&d/pmpa meeting":"PMPA",
    "tomas signoff":"Admin",
    "finalising scrap pallet":"Scrapping",
    "ict& aortic tier": "Meeting",
    "ra bsi query":"Data Request/Review",
    "email/im . scrum":"Email & IM",
    "lit call": "Meeting",
    ...
    "emails escalated call and update":"Email & IM",
    "ri x":"RI",
    ...
    "report check":"Team Report",
    "cs training": "Training/Mentoring",
    "? time needed to review of assessment events?":"WIP/Event Review",
    "general":"WIP/Event Review",
    "review of assessment file":"WIP/Event Review",
    ...
    "reading dcb device documentation":"Reviewing Documents & Case Video",
    "a3 problem solving":"Problem Solving",
    "eu training(60)": "Training/Mentoring",
    "scrum/cornerstone/imbox/2 rrs":"Scrum & Action",
    "appt.":"Appointment",
    "ad hoc questions/messages with pmpa for letter":"PMPA",
    "lab clean up":"Admin",
    "ordering chemical":"Ordering",
    "voyager tm meeting":"Meeting",
    "*":"",
