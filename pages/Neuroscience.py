...
def normalize_person_name(name: str) -> str:
    ...
    aliases = {
        ...
        _norm("madelyn guenther"): "Madelyn",
        ...
        _norm("badugu, aravind kumar"): "Aravind Badugu",
        _norm("aravind kumar badugu"): "Aravind Badugu",
        _norm("aravind badugu"): "Aravind Badugu",
