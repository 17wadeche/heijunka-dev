...
FY27_FISCAL_MONTHS = {
    ...
    "June '27":      ("2026-06-01", "2026-06-29"),
    "July '27":      ("2026-07-06", "2026-07-27"),
    "August '27":    ("2026-08-03", "2026-08-24"),
    "September '27": ("2026-08-31", "2026-09-28"),
    "October '27":   ("2026-10-05", "2026-10-26"),
    "November '27":  ("2026-11-02", "2026-11-23"),
    "December '27":  ("2026-11-30", "2026-12-28"),
    "January '28":   ("2026-01-04", "2027-01-25"),
    "February '28":  ("2027-02-01", "2027-02-22"),
    "March '28":     ("2027-03-01", "2027-03-29"),
    "April '28":     ("2027-04-05", "2027-04-26"),
}
FY27_FISCAL_MONTHS = {
...
def _build_unaccounted_time_export(
    ...
    export = export[
        ...
        .str.strip()
        .str.casefold()
        .isin(UNACCOUNTED_TIME_EXPORT_EXCLUDED_PEOPLE)
    ].copy()
    if export.empty:
        return pd.DataFrame(columns=columns)
