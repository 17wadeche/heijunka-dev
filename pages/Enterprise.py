...
def merged_people_count_for_week(
    ...
    if nw_frame is not None and not nw_frame.empty and team in {"ENT", "DBS", "NV", "Enabling Technologies", "Spine", "PH"}:
...
def _weekly_team_export_df(
    ...
    for _, nw_row in nw.iterrows():
        ...
        if team in {"NV", "Enabling Technologies", "DBS", "PH", "Spine", "PSS"}:
