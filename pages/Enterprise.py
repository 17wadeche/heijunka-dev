...
FY27_FISCAL_MONTHS = {
    "May '27":       ("2026-04-27", "2026-05-24"),
    "June '27":      ("2026-05-25", "2026-06-21"),
    "July '27":      ("2026-06-22", "2026-07-26"),
    "August '27":    ("2026-07-27", "2026-08-23"),
    "September '27": ("2026-08-24", "2026-09-20"),
    "October '27":   ("2026-09-21", "2026-10-25"),
    "November '27":  ("2026-10-26", "2026-11-22"),
    "December '27":  ("2026-11-23", "2026-12-20"),
    "January '28":   ("2026-12-21", "2027-01-24"),
    "February '28":  ("2027-01-25", "2027-02-21"),
    "March '28":     ("2027-02-22", "2027-03-21"),
    "April '28":     ("2027-03-22", "2027-04-25"),
}
FY27_FISCAL_MONTHS = {
...
def merged_people_count_for_week(
    ...
    if nw_frame is not None and not nw_frame.empty and team in {"ENT", "DBS", "NV", "Enabling Technologies", "Lit & Letters", "Spine", "PH", "SCS", "TDD", "ACM","CPT","DS","CDS","NI", "VSS","Endoscopy","Surgical AST-GST","PH-NM MEIC","TCT"}:
