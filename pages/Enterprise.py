...
def _canon_activity(label: str) -> str:
    ...
    explicit_map = {
        ...
        "classroom training (d2d, emea, etc)":"Training",
        "trainer/ mentor (development and delivery)":"Training",
        ...
        "training, ps event reviews, collaboration, meetings, emails/admin, filling out pa board":"Training",
        ...
        "training/review practice event":"Training",
        ...
        "precedent event review, training, meeting":"Training",
        ...
        "training, collaboration, pull work, scrum":"Training",
        ...
        "training took whole day, meetings went over, pulling training events took a while since training environment is having tech issues, many technical difficultie": "Training",
        "metrics, schedule, ri help":"Admin",
        "training, ml rd proj meeting, collaboration":"Training",
        "metrics, schedule, lab call, collaboration, training event review, data pull":"Admin",
        "1.5 hours training/shadow":"Training",
        ...
        "training, late mdr, metrics, cross collab qs, metrics/schedule, cornerstone":"Training",
        ...
        "reviwed affera training material for anna wright/stacy r.":"Training",
        "reverse shadow":"Training",
...
with tabs[1]:
    ...
    if pie_rows:
        ...
        if pie_rolled.empty:
            ...
            st.stop()
        if len(pie_rolled) > 21:
            top_pie = pie_rolled.head(21)
            other_pie = pd.DataFrame(
                [{
                    "activity": "Other",
                    "hours": float(pie_rolled["hours"].iloc[21:].sum()),
                }]
            )
