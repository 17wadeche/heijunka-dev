...
def split_nonwip_activity_minutes(cat: pd.DataFrame) -> pd.DataFrame:
    ...
    def _canon_activity(label: str) -> str:
        ...
        explicit_map = {
            ...
            "live case video":"Reviewing Documents & Case Videos",
            "reviewing documents, live case video":"Reviewing Documents & Case Videos",
            "reviewing documents, projects list":"Reviewing Documents & Case Videos",
            "line tour":"Tour",
